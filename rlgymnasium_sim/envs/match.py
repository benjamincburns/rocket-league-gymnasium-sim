...
from rlgymnasium_sim.envs.environment import Environment
from rlgymnasium_sim.utils.gamestates import GameState
...
class Match(Environment):
    ...
    def _auto_detect_obs_space(self):
        from rlgymnasium_sim.utils.gamestates.player_data import PlayerData
