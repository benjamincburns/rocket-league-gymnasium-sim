...
from rlgymnasium_sim.gym import Gym
from rlgymnasium_sim.envs import Match
from rlgymnasium_sim.utils.terminal_conditions import common_conditions
from rlgymnasium_sim.utils.reward_functions import DefaultReward
from rlgymnasium_sim.utils.obs_builders import DefaultObs
from rlgymnasium_sim.utils.action_parsers import DefaultAction
from rlgymnasium_sim.utils.state_setters import DefaultState
...
def make(tick_skip: int = 8,
    ...
    :param terminal_conditions: List of terminal condition objects (rlgymnasium_sim.utils.TerminalCondition)
    :param reward_fn: Reward function object (rlgymnasium_sim.utils.RewardFunction)
    :param obs_builder: Observation builder object (rlgymnasium_sim.utils.ObsBuilder)
    :param action_parser: Action parser object (rlgymnasium_sim.utils.ActionParser)
    :param state_setter: State Setter object (rlgymnasium_sim.utils.StateSetter)
    :return: Gym object
    """
